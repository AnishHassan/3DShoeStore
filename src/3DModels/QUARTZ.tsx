...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const gltf = useLoader(GLTFLoader, '/3DShoeStore/Model/QUARTZ.glb');
  ...
  const { nodes, materials } = useGLTF('/3DShoeStore/Model/QUARTZ.glb') as GLTFResult

  return (
    <group ref={groupRef} {...props} position={[0, 0, 0]}>
      <group dispose={null} scale={30} position={[0, 0, 0]} >
...
useGLTF.preload('/3DShoeStore/Model/QUARTZ.glb')
